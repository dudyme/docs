---
title: 'Quick Start'
description: 'Learn how to start using Call24x7.AI and make your first AI-driven call'
---
...
Head to the Call24x7.AI [Developer Portal](https://call24x7.ai/developer) to create an account. Complete your details, verify your phone number, and access your account dashboard.

Once registered, navigate to the **Send Call** page to test sending a call directly from the portal.

<CodeGroup>
  <Code title="Setup your API key" active>
...
<Callout title="Need Assistance?" type="success">
